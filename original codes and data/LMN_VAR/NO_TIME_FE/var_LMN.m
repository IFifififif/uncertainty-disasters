...
% var_LMN.m
%
% This MATLAB code computes no time FE admissible sets for the 
...
for randct=1:N
      ...
      if (mean_shocks_store(3,randct)>0.1)&...
          (mean_shocks_store(2,randct)<-0.05)&...
          (mean_shocks_store_coup(3,randct)>0.1)&...
          (mean_shocks_store_coup(2,randct)>0.05)&...
