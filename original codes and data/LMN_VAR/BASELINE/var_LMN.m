...
% var_LMN.m
%
% This MATLAB code computes baseline admissible sets for the 
...
for randct=1:N
    ...
    g_val_vec = [mean_shocks_store(3,randct)-0.15; ...
                mean_shocks_store(2,randct)+0.1; ...
                mean_shocks_store_coup(3,randct)-0.15; ...
                mean_shocks_store_coup(2,randct)-0.1; ...
                mean_shocks_store_nat(2,randct);...
                mean_shocks_store_ter(2,randct)];
                
    g2_val_store(randct) = sum(g_val_vec.^2);
...
for randct=1:N
      ...
      if (mean_shocks_store(3,randct)>0.15)&...
          ...
          (mean_shocks_store_coup(3,randct)>0.15)&...
          (mean_shocks_store_coup(2,randct)>0.1)&...
          (mean_shocks_store_nat(2,randct)<0.0)&...
          (mean_shocks_store_ter(2,randct)<0.0);
