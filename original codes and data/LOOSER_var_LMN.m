...
% var_LMN.m
%
% This MATLAB code computes looser restriction admissible sets for the 
...
for randct=1:N
     ...
     if (mean_shocks_store(3,randct)>0.14)&...
          (mean_shocks_store(2,randct)<-0.09)&...
          (mean_shocks_store_coup(3,randct)>0.14)&...
          (mean_shocks_store_coup(2,randct)>0.09)&...
