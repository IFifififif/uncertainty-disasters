    ...
    def step2_admissible_sets(
        ...
        for randct in range(n_draws):
            ...
            if pass_cond:
                ...
                admissible_rand_irfs.append(rand_IRF.copy())
